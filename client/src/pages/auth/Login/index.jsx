                ...
                <div className="card">
                    ...
                    <div className="card__password">
                        ...
                        <div className="password_input">
                            ...
                            />
                            <img
                                src={eye_pass ? eye_opened : eye_closed}
                                onClick={() => {
                                    set_eye_pass(prev => !prev);
                                }}
                                className="card__pass-eye"
                            />
                        </div>

                        {errors.includes('wrong_password') && (
                            <span className="card__wrong">Неверный пароль</span>
                        )}
                    </div>

                    <div className="card__prompt">
                        <a href="#">
                            <div className="card__help --v2 --ld">
                                {' '}
                                Забыли пароль?{' '}
                            </div>
                        </a>
