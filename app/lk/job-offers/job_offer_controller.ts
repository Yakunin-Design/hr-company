...
export default function job_offer_controller(old_data?: form_data) {
    ...
    const [form_data, set_form_data] = useState({
        ...
        city: old_data?.city || "Санкт-Петербург",
        ...
        description: old_data?.description || "Обязанности: \n  -\n  -\nТребования:\n   -\n   -\nУсловия:\n   -\n   -"
    })
    ...
    return {min_job_offers, points, form_data, errors, handle_change, create_jo};
}
