...
export default function MainInfo(props: main_info) {
    ...
    if (props.citizenship === "РФ") citizenship_emoji = "🇷🇺";

    if (props.citizenship === "Беларусь / Украина") citizenship_emoji = "🇧🇾/🇺🇦";

    if (props.citizenship === "СНГ") citizenship_emoji = "";

    if (props.citizenship === "Другое") citizenship_emoji = "";
            ...
            <Padding className={style.card_padding}>
				...
				*/}
                ...
                <Row>
                    ...
                    <Subway
                        station={props.subway || "Не указанно"}
                        text_style="h3"
                    />
                </Row>
            </Padding>
